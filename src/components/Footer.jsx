    ...
    <footer className="bg-dark-950/80 backdrop-blur-xl py-12 md:py-16 fade-in-up relative">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-8 flex flex-col md:flex-row justify-between items-center text-center md:text-left">
        ...
        <div className="flex flex-col items-center md:items-end gap-6">
          ...
          <a
            href="https://github.com/endraekacipta-arch"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-2 text-gray-400 hover:text-gold-base transition-colors duration-300 group"
          >
            ...
            <span className="text-[9px] md:text-[10px] uppercase tracking-widest">GitHub</span>
          </a>
        </div>
      </div>
    </footer>
